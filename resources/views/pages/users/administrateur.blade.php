...
@section('content')
    <div class="container">
        <h2 class="main-title">Administrateurs</h2>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
            <div class="btn-group">
                <button type="button" class="btn btn-primary btn-sm"
                        data-toggle="modal" data-target="#bs-example-modal-sm">
                    <i class="mdi mdi-plus-circle"></i>Ajouter un administrateur
                </button>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="mySmallModalLabel">Ajouter un administrateur</h4>
                ...
                <div class="">
                    <form class="form" method="POST" action="{{route('users.store')}}">
                        ...
                        <div class="row">
                            ...
                            <input class="form-input" value="0" type="text" hidden  name="user_type" placeholder="" required>
