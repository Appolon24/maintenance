        ...
        <div class="row stat-cards">
            <div class="col-md-6 col-xl-3">
                <article class="stat-cards-item">
                    ...
                    <div class="stat-cards-info">
                        <p class="stat-cards-info__num">{{sizeof($vistes)}}</p>
            ...
            <div class="col-md-6 col-xl-3">
                <article class="stat-cards-item">
                    ...
                    <div class="stat-cards-info">
                        <p class="stat-cards-info__num">{{sizeof($customers)}}</p>
                        <p class="stat-cards-info__title">Total clients</p>
                        <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit success">
            ...
            <div class="col-md-6 col-xl-3">
                <article class="stat-cards-item">
                    ...
                    <div class="stat-cards-info">
                        <p class="stat-cards-info__num">{{sizeof($depannages)}}</p>
                        <p class="stat-cards-info__title">Total depannages</p>
                        <p class="stat-cards-info__progress">
            ...
            <div class="col-md-6 col-xl-3">
                <article class="stat-cards-item">
                    ...
                    <div class="stat-cards-info">
                        <p class="stat-cards-info__num">{{sizeof($sorties)}}</p>
                        <p class="stat-cards-info__title">Total fiches sorties</p>
                        <p class="stat-cards-info__progress">
